...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    MessageChannel *channel = [MessageChannel shared];
    [ChannelPlugin addMethodCallDelegate: channel];
    ...
    router.navigationController = nvc;
    channel.navigationController = nvc;
